...
xcodebuild -configuration "$configuration" -exportArchive -exportFormat ipa -archivePath "$build_location/App-$NOW.xcarchive" -exportPath "$build_location/$ipaname.ipa" -exportProvisioningProfile "$provision"
